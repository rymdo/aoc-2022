...
function isContained(sectionPair) {
  ...
  if (JSON.stringify(section1) == JSON.stringify(intersection)) {
    return true
  }
  if (JSON.stringify(section2) == JSON.stringify(intersection)) {
    return true
  }
  return false
}
...
console.log(`day4 - part1 - count: ${containedCount}`)